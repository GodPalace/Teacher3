package com.godpalace.teacher3.fx.window;
...
@Getter
@Setter
public class DeputyWindow extends Stage {
    ...
    public DeputyWindow(String title, Type type, int insets, Size size) {
        this(title);
    ...
    public DeputyWindow(String title) {
        super();
